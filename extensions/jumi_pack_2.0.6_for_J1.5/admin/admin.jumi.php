    ...
    function editApplication(&$row) {
        ...
        <fieldset class="adminform">
            ...
            <tr>
                ...
                <td>
                    <div id="editor"><?php echo @$row->custom_script; ?></div>
                    <style type="text/css">
                        #editor {
                            position: relative;
                            width: 700px;
                    ...
                    <script src="/media/system/js/ace/ace-uncompressed.js" type="text/javascript"charset="utf-8"></script>
                    <script src="/media/system/js/ace/mode-php.js" type="text/javascript" charset="utf-8"></script>
                    <script type="text/javascript">
                        window.onload = function() {
                            ...
                            editor.getSession().on('change', function() {
                                console.info('change');
                                var textarea = $('custom_script');
                                textarea.value = editor.getSession().getValue();
                            });
                        }
                    </script>
                    <textarea name="custom_script"
                              id="custom_script" cols="80" rows="10"
                              style="display: none"><?php echo @$row->custom_script; ?></textarea>
                </td>
            </tr>
            <tr>
                <td class="key">
